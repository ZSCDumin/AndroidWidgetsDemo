    ...
    private void initEvent() {
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {//ViewPager滑动切换监听
            ...
            public void onPageSelected(int arg0) {
                ...
                switch (currentItem) {
                    case 0:
                        mImageViewChat.setImageResource(R.drawable.pic1);
                        break;
                    case 1:
                        mImageViewFrd.setImageResource(R.drawable.pic2);
                        break;
                    case 2:
                        mImageViewFind.setImageResource(R.drawable.pic3);
                        break;
                    case 3:
                        mImageViewMe.setImageResource(R.drawable.pic4);
                        break;
                    default:
                        break;
                }
